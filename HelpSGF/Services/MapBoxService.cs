...
namespace HelpSGF.Services
{
    ...
    public class MapBoxService : IMapBoxService
    {
        ...
        public static string AccessToken = "sk.eyJ1IjoiaGVscHNnZiIsImEiOiJjanBzMG93YXoxZnozNDNydWNvY2t0N29jIn0.ElPdHGCxM3OLVScypml43A";
        public static string Username = "helpsgf";
